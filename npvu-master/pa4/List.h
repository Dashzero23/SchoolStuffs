...
*********************************************************************************/
// Pretty much everything here is copy/pasted from the pa1.pdf, except the typedef struct part, which I learned how to make from CSE 13s
#include <stdio.h>
#include <stdlib.h>
#include <stdbool.h>
...
void moveNext(List L); // If cursor is defined and not at back, move cursor one
 ...
 // do nothing                                      // back of L. If cursor is defined and at back, cursor becomes undefined.
